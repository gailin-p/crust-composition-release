...
for (l, layer) in enumerate(LAYER_NAMES)
	...
	for (i, camera) in enumerate(cameras)
		...
		for model in models.models[layer]
			...
			plot!(q, model.seismic[1:models.nbins:total,2], # rho
				...
				camera=camera, marker_z=model.comp[1:models.nbins:total,2], zlims=(1.25,2.0),
	...
	savefig(p, "$outputPath/3dplot_colorbar_$layer.png")
end

r = plot(layer_plots..., size=(1500, 600), layout=(1,3))
savefig(r, "$outputPath/3dplot_all_layers_colorbar.png")
