...
function worker() 
	...
	while true 
		...
		upperDat, (upperCrustbase, upperAge, upperLat, upperLong) = getAllSeismic(6, n=5000, ageModel=age_model, latlong=true) # returns rho, vp, vpvs, tc1, age
		middleDat, (middleCrustbase, middleAge, middleLat, middleLong) = getAllSeismic(7, n=5000, ageModel=age_model, latlong=true)
		lowerDat, (lowerCrustbase, lowerAge, lowerLat, lowerLong) = getAllSeismic(8, n=5000, ageModel=age_model, latlong=true)
